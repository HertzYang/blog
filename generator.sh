main=index.html
cat /dev/null > $main
echo $'<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><title>Hertz\'s Blog</title></head><body><h1>Hertz\'s Blog</h1><p>Seriously, it is really a blog in 2022!<br><a href="generator.sh">生成器文件</a> 作者不可考</p><ul>' > $main
for i in `ls`; do
...
echo '<li><a target="_blank" href="https://blog.pppwaw.top">PPPWAW Blog</a></li>' >> $main
